const plants = [
    {
      ...
      price: '39.99',
      like: true,
      img: require('../assets/images/plant_image/plant1.png'),
      about:
  ...
  
    {
      ...
      price: '29.99',
      like: false,
      img: require('../assets/images/plant_image/plant2.png'),
      about:
    ...
    },
    {
      ...
      price: '25.99',
      like: false,
      img: require('../assets/images/plant_image/plant3.png'),
      about:
  ...
  
    {
      ...
      price: '25.99',
      like: false,
      img: require('../assets/images/plant_image/plant4.png'),
      about:
    ...
    },
    {
      ...
      price: '50.99',
      like: false,
      img: require('../assets/images/plant_image/plant5.png'),
      about:
        'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
    {
      ...
      price: '50.99',
      like: false,
      img: require('../assets/images/plant_image/plant6.png'),
      about:
        'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
  ];
